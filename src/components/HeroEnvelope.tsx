...
export function HeroEnvelope() {
  ...
  const handleOpenEnvelope = () => {
    // Trigger a gentle confetti effect
    confetti({
      particleCount: 30,
      spread: 50,
      origin: { y: 0.6 },
  ...
  return (
    <section className="py-12 md:py-20 px-4 flex flex-col items-center justify-center min-h-[80vh] bg-[#f9fafb] relative overflow-hidden">
